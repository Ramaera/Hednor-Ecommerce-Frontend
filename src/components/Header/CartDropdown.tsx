      ...
      {({ open, close }) => (
        <>
          <Popover.Button
            ...
            <div>
              <div className="w-3.5 h-3.5 flex items-center justify-center bg-primary-500 absolute top-1.5 right-3 rounded-full text-[10px] leading-none text-white font-medium">
